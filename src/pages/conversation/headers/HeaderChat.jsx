...
const HeaderChat = () => {
    ...
    const {image, user, logout} = useAuth();
    ...
    let saludo = (horaActual >= 5 && horaActual < 12) ? 'Good Morning!'
        : (horaActual >= 12 && horaActual < 18) ? 'Good Afternoon!'
            : (horaActual >= 18 && horaActual < 21) ? 'Good Evening!'
                : 'Good Night!';
    ...
    return (
        <div className="relative flex rounded-md mt-auto items-center pl-2 pb-2 border-b-2">
            ...
            <div className="flex flex-col">
                ...
                <p className="pl-4 text-black font-SansCaption text-sm">{user}</p>
            </div>
